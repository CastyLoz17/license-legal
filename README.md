...
This repository contains the official legal text of the NCLCE License.

**Official License URL:** https://copyright.sillyy.gay
...
Based on CC BY-NC-SA 4.0 with custom commercial exception mechanism.
